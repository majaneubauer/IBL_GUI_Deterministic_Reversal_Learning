...
# FIXME min_trials is 43 in original, to test, keep at 0 for now
def _iterate_protocols(subject_folder: Path, task_name: str, n: int = 1, min_trials: int = 0) -> list[dict]:
    """
